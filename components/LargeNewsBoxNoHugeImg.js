    ...
    return (
      <div className="col-span-3 px-4 ">
        <div className="grid grid-cols-2 gap-2">
          ...
          {/* New grid */}
          <div className="grid col-span-2 md:col-span-1 xl:col-span-3 xl:grid-cols-2">
            <div className="xl:hidden capitalize flex items-center w-full font-semibold font-serif col-span-3 text-lg lg:text-2xl  hover:text-red-600 xl:py-4">
              <Link href={"/article/" + slug.current}>
                <a>
                  <h1>{title}</h1>
                </a>
            ...
            <div className=" hidden xl:flex justify-center items-center  pt-4">
              <p className="text-sm sm:text-base">
                {description.substring(0, 130)}...
              </p>
            </div>
            <div className="xl:border-l  px-0 xl:px-4 col-span-1">
